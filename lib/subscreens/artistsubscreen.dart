...
class ArtistSubScreen extends StatefulWidget {
  final artistId;
  final artistname;

  const ArtistSubScreen({Key key, this.artistId, this.artistname})
      : super(key: key);
  @override
  _ArtistSubScreenState createState() => _ArtistSubScreenState();
}

class _ArtistSubScreenState extends State<ArtistSubScreen> {
        ...
        body: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              Container(
                height: 680 * cst.responsiveCofficient(context),
